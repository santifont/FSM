...
public class PistoleroEstado
{
    protected GameObject agente;
    protected GameObject jugador;

    public void InicializarFSM(GameObject _pistolero, GameObject _jugador)
    {
    ...
    protected PistoleroEstado siguienteEstado; // El estado que se EJECUTARÁ A CONTINUACIÓN del estado actual

    // Constructor
    public PistoleroEstado()
    {
    ...
    public PistoleroEstado Procesar()
    {
    ...
    protected bool JugadorEstaCerca()
    {
